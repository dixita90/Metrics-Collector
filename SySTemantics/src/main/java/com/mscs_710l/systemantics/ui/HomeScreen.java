...
public class HomeScreen extends Application {
  ...
  /**
   * This function sets the scene, i.e all UI elements. Four tabs are created to
   * display Process,Memory, Network and System related data. Data is populated
   * in the tables by executing commands.
   *
